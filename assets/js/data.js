...
const PROFIL = {
  ...
  outils: {
    "Langages": ["Java", "Python", "C", "SQL", "HTML / CSS"],
    "Données": ["PostgreSQL", "pgAdmin", "Modélisation MCD / MLD"],
    "Outils": ["Git / GitHub", "Trello", "IntelliJ", "VS Code", "Suite Office"],
    "Systèmes": ["Linux", "Windows", "VirtualBox"]
  }
};
